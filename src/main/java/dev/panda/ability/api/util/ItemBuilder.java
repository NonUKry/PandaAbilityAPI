package dev.panda.ability.api.util;
...
public class ItemBuilder {
    ...
    private List<String> translate(List<String> input) {
        return input.stream().map(s -> ChatColor.translateAlternateColorCodes('&', s)).collect(Collectors.toList());
    }
}